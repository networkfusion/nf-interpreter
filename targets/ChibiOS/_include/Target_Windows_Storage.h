...
#define SD_CARD_VOLUME_INDEX         "0"
#define SD_CARD_VOLUME_INDEX_NUMERIC (0)

#endif

#if (HAL_USE_SDC == TRUE) && defined(HAL_USBH_USE_MSD)

#define USB_MSD_VOLUME_INDEX         "1"
#define USB_MSD_VOLUME_INDEX_NUMERIC (1)

#elif (HAL_USE_SDC == FALSE) && defined(HAL_USBH_USE_MSD)

#define USB_MSD_VOLUME_INDEX         "0"
#define USB_MSD_VOLUME_INDEX_NUMERIC (0)
